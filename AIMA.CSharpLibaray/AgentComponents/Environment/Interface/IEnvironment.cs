...
namespace AIMA.CSharpLibrary.AgentComponents.Environment.Interface
{
    ...
    /// <typeparam name="TAgent">Type which is used to represent the agents added to the environment.</typeparam>
    ...
    public partial interface IEnvironment<TPerformanceMeasure, TAgent, TPrecept, TAction>
        where TAction : BaseAction, new()
        where TPrecept : BasePrecept, new()
         where TPerformanceMeasure: BasePerformanceMeasure, new() 
        where TAgent : BaseAgent<TPerformanceMeasure, TPrecept, TAction>
    {



        /// <summary>
        /// <para>There maybe (N)Number of agents operating within the environment.</para>
        /// </summary>
        ...
        /// </summary>
        /// <param name="agent">The agent to be added to the current environment.</param>
        void AddAgent(TAgent agent);

        /// <summary>
        /// Remove an agent from the environment.
        /// </summary>
        /// <param name="agent">The agent to be removed from the current environment.</param>
        ...
        /// </summary>
        /// <param name="cancellationToken">Task Cancellation Token, Uses to handle the cancellation of stepping through the environment.</param>
        /// <returns></returns>
        ...
        //T GetAgentPerformanceMeasure(TAgent agent);

        /// <summary>
        /// Creates random environmental change with in the environment this is to test the rigor of the agent program for example.
        /// <para>
        ...
        //void ProcessAgentActuators(TAgent agent, TAction action);
        ...
        ///// <returns></returns>
        //bool UpdatePerformanceMeasure(TAgent forAgent, T addTo);
    }
}
